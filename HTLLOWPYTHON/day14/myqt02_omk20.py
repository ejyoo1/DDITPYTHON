...
class WindowClass(QMainWindow, form_class): 
    ...
    def btnClick(self):
        ...
        self.flag_wb = not self.flag_wb #흑돌 백돌 변경
        print(self.flag_wb)
    ...
    def com_wb(self):
        com_i = 0
        self.arr2D[com_i][self.com] = 1
        stone = 1
        
        up = self.getUP(com_i,self.com,stone)
        dw = self.getDW(com_i,self.com,stone)
        le = self.getLE(com_i,self.com,stone)
        ri = self.getRI(com_i,self.com,stone)
        ur = self.getUR(com_i,self.com,stone) #오른쪽 위
        dl = self.getDL(com_i,self.com,stone) #왼쪽 아래
        ul = self.getUL(com_i,self.com,stone) #오른쪽 위
        dr = self.getDR(com_i,self.com,stone) #왼쪽 아래
